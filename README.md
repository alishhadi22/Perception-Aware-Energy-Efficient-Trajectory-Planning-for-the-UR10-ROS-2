...
- `results/` — HTML evaluation-history plots for each optimizer, on two
  ...
  - [CMA-ES — Path 1](https://alishhadi22.github.io/Perception-Aware-Energy-Efficient-Trajectory-Planning-for-the-UR10-ROS-2/results/cmaes_path1_evals.html) · [Path 2](https://alishhadi22.github.io/Perception-Aware-Energy-Efficient-Trajectory-Planning-for-the-UR10-ROS-2/results/cmaes_path2_evals.html) 
